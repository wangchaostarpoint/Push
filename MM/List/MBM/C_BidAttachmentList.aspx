<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="C_BidAttachmentList.aspx.cs"
    Inherits="Zhongsoft.Portal.MM.List.MBM.C_BidAttachmentList" MasterPageFile="~/Custom/UI/Master/CustomListNew.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvList" AutoGenerateColumns="false"
        DataKeyNames="OUTLINEATTACHMENTID" AllowFrozing="true" FrozenColNum="2" ShowExport="true"
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="附件名称" ItemStyle-Width="90%">
                <ItemTemplate>
                    <a href="/portal/sys/fileDocument/FileDownload.aspx?fileId=<%#Eval("OUTLINEATTACHMENTID") %>"
                        target="_parent" title="点击下载文件" class="kpms-attachmenta" style="text-decoration: underline;
                        color: #0033FF;">
                        <%# Eval("OUTLINEATTACHMENTNAME")%>
                    </a>
                </ItemTemplate>
            </asp:TemplateField>
        </Columns>
