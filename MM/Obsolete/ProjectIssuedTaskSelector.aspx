<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectIssuedTaskSelector.aspx.cs"
    Inherits="Zhongsoft.Portal.MM.Obsolete.ProjectIssuedTaskSelector" MasterPageFile="~/UI/Master/ObjectSelector.Master"
    Title="选择任务" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView BindJsonClick="true" ID="gvContract" AllowPaging="true"
        ...
        DataKeyNames="TASKINFOFORMID" ShowJsonRowColName="true">
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="MARKETPROJECTNAME" HeaderText="工程名称" ShowToolTip="true"
                Width="120">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="CUSTOMERNAME" HeaderText="业主名称" ShowToolTip="true"
                Width="120">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="RECEIVEPROXYDATE" HeaderText="接收委托书时间" DataFormatString="{0:yyyy-MM-dd}">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="TASKISSUEDDATE" HeaderText="任务下达时间" DataFormatString="{0:yyyy-MM-dd}">
            </zhongsoft:LightBoundField>
