<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WF_TenderProjectApproveForm.ascx.cs"
    Inherits="Zhongsoft.Portal.MM.Form.MDM.WF_TenderProjectApproveForm" %>
...
<table class="tz-table" width="100%">
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbBelongProjectPackage" field="BelongProjectPackage"
                tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)"></zhongsoft:LightTextBox>
        </td>
    </tr>
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox runat="server" ID="tbProjectName" field="ProjectName"
                req="1" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)"></zhongsoft:LightTextBox>
        </td>
    </tr>
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightObjectSelector runat="server" ID="txtCustomerName" IsMutiple="false"
                ...
                req="1" field="CustomerName" activestatus="(23.提交投标项目立项申请)" DoCancel="false" Writeable="false" AfterSelect="checkUser()" />
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightObjectSelector runat="server" ID="txtEntrustUnitName" IsMutiple="false"
                ...
                ShowJsonRowColName="true" ResultAttr="name" tablename="MM_MarketInfo" Filter="{IsOrderByHit:'1'}"
                req="1" field="EntrustUnitName" activestatus="(23.提交投标项目立项申请)" DoCancel="false" Writeable="false" AfterSelect="checkUser()" />
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightObjectSelector runat="server" ID="txtContacter" IsMutiple="false"
                ShowSelectBtn="true" SelectPageMode="Dialog" activestatus="(23.提交投标项目立项申请)" SourceMode="SelectorPage"
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText runat="server" ID="txtContacterPhone"
                req="1" class="kpms-textbox" activestatus="(23.提交投标项目立项申请)" field="ContacterPhone"
                tablename="MM_MarketInfo">
        ...
        <td class="td-r">
            <asp:RadioButtonList runat="server" ID="rblImportantLevel" field="ImportantLevel" tablename="MM_MarketInfo"
                req="1" RepeatDirection="Horizontal" activestatus="(23.提交投标项目立项申请)">
            </asp:RadioButtonList>
        </td>
    </tr>
    <tr>
        ...
        <td class="td-r">
            <asp:RadioButtonList runat="server" ID="rbIsChurchyard" field="IsChurchyard" tablename="MM_MarketInfo"
                req="1" RepeatDirection="Horizontal" activestatus="(23.提交投标项目立项申请)" AutoPostBack="true"
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList ID="ddlProvince" runat="server" activestatus="(23.提交投标项目立项申请)"
        ...
        <td class="td-r">
            ...
            <zhongsoft:LightDropDownList ID="ddlArea" runat="server" activestatus="(23.提交投标项目立项申请)" field="Area" tablename="MM_MarketInfo" req="1" onchange="return autoBuildPlace();">
            </zhongsoft:LightDropDownList>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="td-r" colspan="5">
            <asp:RadioButtonList runat="server" ID="rblBusinessPlate" field="ParamBusinessPlateID" tablename="MM_MarketInfo"
                RepeatDirection="Horizontal" activestatus="(23.提交投标项目立项申请)" req="1">
            </asp:RadioButtonList>
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList runat="server" ID="ddlProjectType" TableName="MM_MarketInfo"
                Field="ParamProjectTypeID" activestatus="(23.提交投标项目立项申请)" req="1">
            </zhongsoft:LightDropDownList>
        ...
        <td class="td-r">
            <zhongsoft:LightDropDownList runat="server" ID="ddlServiceType" TableName="MM_MarketInfo"
                req="1" Field="ServiceType" activestatus="(23.提交投标项目立项申请)">
            </zhongsoft:LightDropDownList>
        </td>
    ...
    <tr>
        ...
        <td class="td-r" style="white-space: nowrap">
            <zhongsoft:LightTextBox runat="server" ID="tbVoltageGrade" field="VoltageGrade" EnableTheming="false"
                CssClass="kpms-textbox-money" DataType="PositiveInteger" Width="80%" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)"></zhongsoft:LightTextBox>KV
        </td>
        <td class="td-l">装机容量
        </td>
        <td class="td-r" style="white-space: nowrap">
            <zhongsoft:LightTextBox runat="server" ID="tbInstalledCapacity" field="InstalledCapacity" EnableTheming="false"
                CssClass="kpms-textbox-money" DataType="PositiveInteger" Width="80%" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)"></zhongsoft:LightTextBox>MW
        </td>
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <asp:CheckBoxList runat="server" ID="cblProjectPhases" activestatus="(23.提交投标项目立项申请)"
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:XHtmlInputText runat="server" ID="txtDutyDeptName" readonly="readonly"
                class="kpms-textbox" activestatus="(23.提交投标项目立项申请)" field="DutyDeptName"
                tablename="MM_MarketInfo">
            </zhongsoft:XHtmlInputText>
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText ID="txtPlanStartTime" runat="server" activestatus="(23.提交投标项目立项申请)" req="1"
        ...
        <td class="td-r">
            <zhongsoft:XHtmlInputText ID="txtPlanFinishTime" runat="server" activestatus="(23.提交投标项目立项申请)" req="1"
        ...
        <td class="td-r" flag="cPlanFinishTime" style="display: none">
            <zhongsoft:XHtmlInputText ID="txtCPlanFinishTime" runat="server" activestatus="(23.提交投标项目立项申请)"
    ...
    <tr>
        ...
        <td class="td-r">
            <zhongsoft:LightTextBox runat="server" ID="tbEstimateContractVal" EnableTheming="false" req="1"
                CssClass="kpms-textbox-money" DataType="Decimal2" activestatus="(23.提交投标项目立项申请)"></zhongsoft:LightTextBox>
        ...
        <td class="td-r" flag="JS" style="display: none">
            <zhongsoft:LightDropDownList runat="server" ID="ddlDelegateType" field="DelegateType" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)" />
        </td>
    </tr>
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox ID="tbProjectDescription" runat="server" TextMode="MultiLine" MaxLength="1024" req="1"
                field="ProjectDescription" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)" CssClass="kpms-textarea"
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox ID="tbProjectScale" runat="server" TextMode="MultiLine" MaxLength="1024" req="1"
                field="ProjectScale" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)" CssClass="kpms-textarea"
                EnableTheming="false"></zhongsoft:LightTextBox>
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightTextBox ID="tbMemo" runat="server" TextMode="MultiLine" MaxLength="1024"
                field="Memo" tablename="MM_MarketInfo" activestatus="(23.提交投标项目立项申请)" CssClass="kpms-textarea"
                EnableTheming="false"></zhongsoft:LightTextBox>
        </td>
    </tr>
    <tr>
        ...
        <td class="td-m" colspan="5">
            <zhongsoft:LightFileUploader runat="server" ID="lbtnUpload" EnableTheming="false"
                DisplayStatus="(3.提交投标项目立项申请)" OnClick="lbtnUpload_Click"><img src="../../Themes/Images/btn_upload.gif" />
                        <span>上传附件</span></zhongsoft:LightFileUploader><span class="req-star" style="float: right;"
                            runat="server" displaystatus="(2.提交投标项目立项申请)"> 请先保存再上传附件</span>
            ...
            <div id="divRecord">
                <span style="float: right;" id="spAdd">
                    <asp:LinkButton runat="server" ID="ibtnRecord" CssClass="subtoolbarlink" EnableTheming="false"
                        OnClientClick="return false" DisplayStatus="(3.提交投标项目立项申请)">
                        <span>
