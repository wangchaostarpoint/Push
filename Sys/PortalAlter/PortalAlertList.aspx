<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortalAlertList.aspx.cs"
    Title="我接收的工作提醒" Inherits="Zhongsoft.Portal.Sys.PortalAlter.PortalAlertList"  MasterPageFile="~/UI/Master/ObjectList.Master"%>
...
<asp:Content ID="Content4" ContentPlaceHolderID="toolBtn" runat="server">
   ...
   <%--<asp:LinkButton ID="btnTest" runat="server" EnableTheming="false" CssClass="btn-query" Visible="false"
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <script type="text/javascript">
        ...
        function DealItem(alertID) {
            var url = "/Sys/PortalAlter/PortalAlertUsersEditor.aspx";
