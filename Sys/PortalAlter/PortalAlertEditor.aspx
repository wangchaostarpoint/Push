<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PortalAlertEditor.aspx.cs"
    Title="工作提醒" Inherits="Zhongsoft.Portal.Sys.PortalAlter.PortalAlertEditor" MasterPageFile="~/UI/Master/ObjectEditor.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    <table id="tz-table" class="tz-table" width="100%">
        ...
        <tr id="trProject">
            ...
            <td class="td-r">
                <zhongsoft:LightObjectSelector runat="server" ID="lbsSelectProject" IsMutiple="false" Filter="{ProjectType:1}"
                    SelectPageMode="Dialog" ResultForControls="{'hiOrganizationID':'id','txtProjectCode':'ProjectCode'}"
                    PageWidth="850" EnableTheming="false" Text="选择项目" PageUrl="~/PPM/Obsolete/ProjectSelector.aspx"
        ...
        <tr>
            ...
            <td class="td-r">
                ...
                <zhongsoft:XHtmlInputText ID="txtAlertTime" runat="server" tablename="PortalAlert" field="AlertTime"  type="text" class="kpms-textbox-wholedate" req="1" 
    ...
    <input type="hidden" id="hiSourceID" runat="server" field="SourceID" tablename="PortalAlert" />
      <input type="hidden" runat="server" id="hiFlag"   field="Flag" tablename="PortalAlert"/>
