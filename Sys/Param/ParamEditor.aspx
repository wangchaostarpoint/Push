<%@ Page Title="系统参数编辑页面" Language="C#" MasterPageFile="~/UI/Master/ObjectEditor.Master"
    AutoEventWireup="true" CodeBehind="ParamEditor.aspx.cs" Inherits="Zhongsoft.Portal.Sys.ParamEditor" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    <table width="100%" class="tz-table">
        ...
        <tr>
            ...
            <td class="td-r">
                <asp:TextBox runat="server" ID="tbParamName" CssClass="kpms-textbox" MaxLength="128"
                    Width="100px" req="1" activestatus="(2.*)"></asp:TextBox>
            </td>
            <td class="td-l">
                参数分类<span class="req-star">*</span>
            </td>
            <td class="td-r">
        ...
        <tr id="trModule">
            ...
            <td class="td-r">
                <asp:DropDownList runat="server" ID="ddlModule" Width="100px" activestatus="(23.*)">
                </asp:DropDownList>
            </td>
            <td class="td-l">
            </td>
    ...
    <script>
        ...
        var $ddlModule = $("#<%=ddlModule.ClientID%>");
        var $dllType = $("#<%=ddlParamType.ClientID%>");

        $dllType.live("change", function () {
            setDDLModule();
        })

        function setDDLModule() {
            if ($dllType.val() == "Module") {
                $("#trModule").show();
                $ddlModule.attr("req", "1");
            }
            else {
                $("#trModule").hide();
                $ddlModule.val("");
                $ddlModule.removeAttr("req");
            }
