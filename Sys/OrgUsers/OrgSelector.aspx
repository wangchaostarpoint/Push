<%@ Page Title="选择部门" Language="C#" MasterPageFile="~/UI/Master/ObjectSelector.Master"
    AutoEventWireup="true" CodeBehind="OrgSelector.aspx.cs" Inherits="Zhongsoft.Portal.Sys.OrgUsers.OrgSelector" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
        ...
        <tr>
            ...
            <td valign="top">
                <zhongsoft:LightPowerGridView BindJsonClick="true" ID="OrgsList" AllowPaging="true"
                    PageSize="20" runat="server" AutoGenerateColumns="false" UseDefaultDataSource="true"
    ...
    <script type="text/javascript">
        function initCustomerPlugin() {
            ...
            var showTreeVal = '<%=Request.QueryString["showTree"]%>';
