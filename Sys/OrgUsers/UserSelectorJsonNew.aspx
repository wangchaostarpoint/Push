<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UserSelectorJsonNew.aspx.cs" Inherits="Zhongsoft.Portal.Sys.OrgUsers.UserSelectorJsonNew"
    MasterPageFile="~/UI/Master/ObjectSelector.Master" Title="选择人员" %>
        ...
        <tr>
            <td style="white-space: nowrap">
                <table>
                    <tr>
                        <td>
                            <asp:RadioButtonList ID="rblGroupType" runat="server" RepeatDirection="Horizontal" OnSelectedIndexChanged="rblGroupType_SelectedIndexChanged"
                                AutoPostBack="true">
                                <asp:ListItem Value="0" Selected="True">按部门</asp:ListItem>
                                <asp:ListItem Value="1">按群组</asp:ListItem>
                            </asp:RadioButtonList>
                        </td>
                ...
                <zhongsoft:LightTextBox ID="tbUserInfo" runat="server" Width="80px" CssClass="kpms-textboxsearch"
                    EnableTheming="false"></zhongsoft:LightTextBox>
                            <a class="subtoolbarlink" id="btnMoreParts" title="在全院人员中搜索">
                             ...
                             <asp:LinkButton runat="server" ID="lkbChoiceAll" OnClick="lkbChoiceAll_Click">
                                        <span content='searchResult'>全选</span>
                             </asp:LinkButton>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <table class="tz-table">
        <tr>
            <td width="35%" valign="top" class="selector-tree">
                <div style="overflow-x: auto; height: 365px !important">
                    <asp:UpdatePanel runat="server" ID="UpdatePanel1" UpdateMode="Always">
                        <ContentTemplate>
                            <uc:OrgTree ID="orgTree" Flag="1" runat="server" />
                            <asp:TreeView runat="server" ID="treeGroup" ShowLines="True" Height="100%">
                    ...
                    <ContentTemplate>
                        <zhongsoft:LightPowerGridView BindJsonClick="true" ID="UsersList" AllowPaging="true"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="SUBDEPTNAME" HeaderText="科室" HeaderStyle-Width="120px"></asp:BoundField>
                            </Columns>
    ...
    <%--陕西省电力设计院--%>
    <input type="hidden" id="hiRootId" value="325C10CA-3B67-4179-A42F-71F9EF16761D" runat="server" />
