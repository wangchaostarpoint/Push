<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkflowVisual.aspx.cs"
    Inherits="Zhongsoft.Portal.Sys.Workflow.WorkflowVisual" %>
...
<body style="overflow: hidden">
    ...
    <div id="silverlightControlHost" style="overflow: hidden">
        <object id="designerContainer" data="data:application/x-silverlight-2," type="application/x-silverlight-2"
            ...
            <param name="initParams" value="ServiceAddress=http://<%=Request.Url.Authority %><%=WebAppPath %>/Sys/SOA/WorkflowService.asmx,Action=1,XPDLIdVar=<%=hiXPDLId.ClientID%>,PackageNameVar=<%=hiPackageName.ClientID%>,PrcInstIdVar=<%= hiPrcInstId.ClientID%>,ActInstId=<%= Request["actInstId"]%>,userid=<%=KPMSUser.Id %>,viewmode=<%=Request["viewmode"] %>,LAN=<%=hiCurLan.Value %>" />
