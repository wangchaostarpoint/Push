<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="WorkToDoTreeList.aspx.cs"
    MasterPageFile="~/UI/Master/ObjectList.Master" Title="待办流程" Inherits="Zhongsoft.Portal.Sys.Workflow.WorkToDoTreeList" %>

<%@ Register Src="Controls/WorkDoneTypeTree.ascx" TagName="WorkDoneTypeTree" TagPrefix="uc1" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="treeView" runat="server">
    <uc1:WorkDoneTypeTree ID="ucWorkDoneTypeTree" runat="server" />
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" AllowPaging="true" PageSize="10" ID="ToDoList"
        ...
        <Columns>
            ...
            <asp:TemplateField>
                <HeaderTemplate>
                   <%-- <img src="../../Themes/Images/readtype_t.gif" title="阅读信息" alt="阅读信息">--%>阅读信息
                </HeaderTemplate>
                <ItemTemplate>
