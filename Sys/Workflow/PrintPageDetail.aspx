<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PrintPageDetail.aspx.cs"
    Inherits="Zhongsoft.Portal.Sys.Workflow.PrintPageDetail" %>
...
<body>
    ...
    <div style="width: 100%; text-align: center">
        ...
        <table width="100%">
            <tr>
                <td id="tdContent" align="center" style="width: 95%">
                </td>
            </tr>
        </table>
    </div>
    ...
    <script type="text/javascript">
        ...
        function GetParam() {
            if (window.opener == null)
                return;
            if (window.opener.document.all.tdContent == null)
                return;
            document.getElementById("tdContent").innerHTML = window.opener.document.all.tdContent.innerHTML;
