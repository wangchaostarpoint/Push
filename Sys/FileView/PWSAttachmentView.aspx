<%@ Page Language="C#" AutoEventWireup="true" Title="门户附件预览" CodeBehind="PWSAttachmentView.aspx.cs" Inherits="Zhongsoft.Portal.Sys.FileView.PWSAttachmentView" %>
...
<body>
    <form id="Form1" runat="server">
         <div id="div2" style="overflow: auto !important; margin: 0 auto; -webkit-overflow-scrolling: touch; text-align:right">
           <a style="color:blue;" href="<%=this.WebAppPath %>/Sys/Handler/FileDownloadHandler.ashx?fileId=<%=FileId%>" >下载文件</a>
        </div>
