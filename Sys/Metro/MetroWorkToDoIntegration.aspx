<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="MetroWorkToDoIntegration.aspx.cs"
    Inherits="Zhongsoft.Portal.Sys.Metro.MetroWorkToDoIntegration" %>
...
<head id="Head1" runat="server">
    ...
    <script type="text/javascript" src="../../themes/script/modernizr.custom.js"></script>
    <style>
        body
        {
            line-height: 1.666;
        ...
        .ico
        {
            ...
            display: inline-block;
            zoom: 1;
            background: url(../../themes/images/unread.png) no-repeat;
            opacity: 0.9;
            left: 2px;
            top: 14px;
            width: 14px;
        ...
        .ico_send
        {
            ...
            display: inline-block;
            zoom: 1;
            background: url(../../themes/images/readed.png) no-repeat;
            opacity: 0.9;
            left: 2px;
            top: 14px;
            width: 14px;
        ...
        *
        {
            scrollbar-face-color: #0c77a1; /*面子深色*/
            scrollbar-arrow-color: #C0C0C0; /*箭头*/
            scrollbar-3dlight-color: #4297b6; /*最外左*/
            scrollbar-highlight-color: #0c77a1; /*滑倒边框左二*/
            scrollbar-shadow-color: #0c77a1; /*滑倒边框右二*/
            scrollbar-darkshadow-color: #4297b6; /*右一*/
            scrollbar-track-color: #4297b6; /*滑道*/
        }
        /*滚动条整体*/
        ::-webkit-scrollbar
        {
...
#tags li a { padding-left: 4px;  float:left; color: #fff;height: 36px; -webkit-transition: color 0.2s;transition: color 0.2s; } 
#tags li.selectTag {  position: relative; height: 33px;border-bottom:3px solid #9bc6d7;-webkit-transition: color 0.2s;transition: color 0.2s; }
#tags li.selectTag A { color:#043a56;-webkit-transition: color 0.2s;transition: color 0.2s;}
#tags li.selectTag A .title1{ padding-bottom:5px;-webkit-transition: color 0.2s;transition: color 0.2s;}
...
<body>
    ...
    <div class="con">
        <script type="text/javascript">
            ...
            function getAllTodoNum(json) {
                $("#todoallNum").html(json.AllCount);
            }
            ...
            function searchTodoList() {
                if (IsResetTime) {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: "MetroWorkToDoIntegration.aspx",
                        data: { "asyfunc": "ResetTimestamp", IsWork: "true" },
                        async: true,
                        dataType: "json",
                        success: function (json) {
                            $("#<%=hiTimestamp.ClientID %>").val(json.TimestampNew);
                            $("#<%=toDoList.ClientID %>").toContentGrid({ OtherParam:
                      '{"UserId":"' + "<%=KPMSUser.UserId %>"
                      + '","DicpUserID":"' + "<%=DicpUserID %>"
                      + '","KpmsUserID":"' + "<%=KpmsUserID %>"
                      + '","ProjKpmsUserID":"' + "<%=ProjKpmsUserID %>"
                      + '","KeyWord":"' + $("#todoKey").val()
            ...
            function interval() {
                $.ajax({
                    type: 'POST',
                    url: "MetroWorkToDoIntegration.aspx",
                    data: { "asyfunc": "Interval", UserId: "<%=KPMSUser.Id %>", DicpUserID: "<%=DicpUserID %>", KpmsUserID: "<%=KpmsUserID %>", ProjKpmsUserID: "<%=ProjKpmsUserID %>", Timestamp: $("#<%=hiTimestamp.ClientID %>").val() },
                    async: true,
                    dataType: "json",
                    success: function (json) {
                        if (json.ToDoNew > 0) {
        ...
        <div>
            <div class="header_title">
                <ul id="tags">
                    <li class="selectTag"><a id="atodolist" content="searchResult" onclick="selectTag('tagContent0',this)">
                        <span class="title1"><b id="todonew" class="new"></b>待办流程(<label id="todoNum">0</label>)</span></a></li>
                </ul>
            </div>
            <div class="search">
                <span>
                ...
                <input class="m_btn" type="button" title="搜索" onclick="return searchTodoList();" />
            </div>
              ...
              <ul>
                  <li class="MT-item" >
                      ...
                      <div>
                        ...
                        <a onclick="sortToDoList('user',this)">&nbsp;<img src="../../themes/images/desc.png" width="9" height="11" style="display:none" />&nbsp;发送人</a>
                        <a onclick="sortToDoList('formtype',this)">&nbsp;<img src="../../themes/images/desc.png" width="9" height="11" style="display:none" />&nbsp;表单类型</a>
                        <a onclick="sortToDoList('org',this)">&nbsp;<img src="../../themes/images/desc.png" width="9" height="11" style="display:none" />&nbsp;发送部门</a>
                        <a onclick="sortToDoList('',this)">&nbsp;<img src="../../themes/images/desc.png" width="9" height="11" />&nbsp;默认</a>
        ...
        <div id="tagContent">
            <div class="tagContent selectTag" id="tagContent0">
                <zhongsoft:ContentGrid runat="server" ID="toDoList" BindMethod="GetAllToDoList" ContentClass="contentgrid_content"
