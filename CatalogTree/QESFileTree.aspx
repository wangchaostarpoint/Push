<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QESFileTree.aspx.cs"
    Inherits="Zhongsoft.Portal.DCMS.List.QESFileTree" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.post("QESFileTree.aspx?organizationID=" + '<%=OrganizationID %>',
                       { asyfunc: "GetProject" },
                           function (res) {
        ...
        function searchTree() {
            ...
            if (word != "") {
                $hikeyword.val(word);
                $.fn.zTree.destroy("treeDemo");
                $.post("QESFileTree.aspx?secid=" + secid + "&type=" + typeValue + "&organizationID=" + '<%=OrganizationID %>',
