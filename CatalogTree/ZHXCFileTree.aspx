<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHXCFileTree.aspx.cs" Inherits="Zhongsoft.Portal.CatalogTree.ZHXCFileTree" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.post("ZHXCFileTree.aspx?organizationID=" + '<%=OrganizationID %>',
                       { asyfunc: "GetProject" },
                           function (res) {
        ...
        function searchTree() {
            ...
            if (word != "") {
                $hikeyword.val(word);
                $.fn.zTree.destroy("treeDemo");
                $.post("ZHXCFileTree.aspx?secid=" + secid + "&type=" + typeValue + "&organizationID=" + '<%=OrganizationID %>',
