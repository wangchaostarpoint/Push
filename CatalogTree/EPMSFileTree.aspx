...
<head id="Head1" runat="server">
    ...
    <style type="text/css">
        ...
        .ztree-container .ztree-container-left {
            width: 260px;
        ...
        .ztree-container .ztree-container-middle {
            ...
            .ztree-container .ztree-container-middle .ztree-container-middle-content {
...
<body>
    <form id="form1" runat="server">
        <div id="metroheader" style="height: 45px;">
        </div>
        ...
        <div>
            ...
            <div class="ztree-container">
                <div class="ztree-container-left float_left" id="tdTree">
                    <div id="prolefttree">
                        <table>
                            <tr style="display: none">
                                <td>
                                    ...
                                    <a onclick="searchTree()" id="btnSearch" class="searchbtn bluecolor"><span>查找</span></a>
                                    <a onclick="resetTree()" id="btnReset" class="searchbtn"><span>重置</span></a>
                ...
                <div class="ztree-container-middle">
                    <div class="ztree-container-middle-content">
                        <div style="width: 100%;">
                            <iframe name="workspace" frameborder="0" id="workspace" width="100%" allowtransparency="true"></iframe>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <script type="text/javascript">
            ...
            //用于：发送流程后跳转回原来打开页面
            function goSelectNode() {
                var treeObj = $.fn.zTree.getZTreeObj("treeDemo");
                var nodes = treeObj.getSelectedNodes();
                var node = treeObj.getNodeByParam('name', "项目", null);//根节点
                if (nodes.length > 0) {
                    node = nodes[0];
                }
                if (node != null) {
                    treeObj.selectNode(node);
                    $("#workspace").attr("src", node.url);
                }
            }
