...
<body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.post("TSMFileTree.aspx?organizationID=" + '<%=OrganizationID %>'+ "&scienceProjectID="+ '<%=ScienceProjectID %>',
                       { asyfunc: "GetProject" },
                           function (res) {
                               ...
                               if ('<%=OrganizationID %>' != '') {
                                   ...
                                   treeObj.selectNode(node);
                                   treeObj.setting.callback.onClick = openUrl(node.url);
                               }else if ('<%=ScienceProjectID %>' != '') {
                                   node = treeObj.getNodeByParam('id', '<%=ScienceProjectID %>', null);
                                   treeObj.selectNode(node);
                                   treeObj.setting.callback.onClick = openUrl(node.url);
                               }
