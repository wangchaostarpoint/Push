<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ZHMFileTree.aspx.cs" Inherits="Zhongsoft.Portal.CatalogTree.ZHMFileTree" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        function getUrl(treeId, treeNode) {
            ...
            return "EPMSFileTree.aspx?keyword=" + encodeURI($hikeyword.val()) + "&secid=" + secid + "&type=" + typeValue;
        }
        ...
        function searchTree() {
            ...
            if (word != "") {
                $hikeyword.val(word);
                $.fn.zTree.destroy("treeDemo");
                $.post("ZHMFileTree.aspx?secid=" + secid + "&type=" + typeValue,
