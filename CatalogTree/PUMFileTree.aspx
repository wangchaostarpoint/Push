<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PUMFileTree.aspx.cs"
    Inherits="Zhongsoft.Portal.DCMS.List.PUMFileTree" %>
...
<body>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function () {
            ...
            $.post("PUMFileTree.aspx?organizationID=" + '<%=OrganizationID %>',
                       { asyfunc: "GetProject" },
                           function (res) {
        ...
        function searchTree() {
            ...
            if (word != "") {
                $hikeyword.val(word);
                $.fn.zTree.destroy("treeDemo");
                $.post("PUMFileTree.aspx?secid=" + secid + "&type=" + typeValue + "&organizationID=" + '<%=OrganizationID %>',
