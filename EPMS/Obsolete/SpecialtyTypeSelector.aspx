<%@ Page Language="C#" AutoEventWireup="true" Title="选择专业类型" MasterPageFile="~/UI/Master/ObjectList.Master"
    CodeBehind="SpecialtyTypeSelector.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.Obsolete.SpecialtyTypeSelector" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="toolBtn" runat="server">
    <asp:LinkButton runat="server" CssClass="subtoolbarlink" EnableTheming="false"
        ...
        <span runat="server" id="span">
            <img runat="server" id="img" src="~/Themes/Images/btn_finish.gif" alt="选择完成" width="16" height="16" />选择完成</span>
    </asp:LinkButton>
    <asp:LinkButton runat="server" CssClass="subtoolbarlink" EnableTheming="false"
        ID="lbtnCancel" OnClientClick="return cancelEdit();"
        ToolTip="取消">
        <span runat="server" id="span2">
            <img runat="server" id="img2" src="~/Themes/Images/btn_cancel.gif" alt="取消" width="16" height="16" />取消</span>
    </asp:LinkButton>
    <script>
        function checkData() {
            return true;
