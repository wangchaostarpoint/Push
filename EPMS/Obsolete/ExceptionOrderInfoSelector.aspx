<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ExceptionOrderInfoSelector.aspx.cs"
    Inherits="Zhongsoft.Portal.EPMS.Obsolete.ExceptionOrderInfoSelector" MasterPageFile="~/UI/Master/ObjectSelector.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView BindJsonClick="true" ID="gvList" AllowPaging="true"
        ...
        DataKeyNames="ExceptionOrderID" ShowJsonRowColName="true" OnRowDataBound="gvList_RowDataBound">
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="ApplyCode" HeaderText="申请书编号" HeaderStyle-Width="40px"
                MaxLength="30">
            ...
            <zhongsoft:LightBoundField DataField="ApplyUserName" HeaderText="申请人" HeaderStyle-Width="10%">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="ApplyTime" HeaderText="发起时间" HeaderStyle-Width="10%"
