<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjMthPlanSpeStatistics.aspx.cs"
    Inherits="Zhongsoft.Portal.EPMS.List.Plan.ProjMthPlanSpeStatistics" MasterPageFile="~/Custom/UI/Master/CustomListNew.Master" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="advSearch" runat="server">
    ...
    <span class="filter-block">
        <span class="filter-block-lb">交出类别</span><span>
...
<asp:Content ID="Content2" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView AllowPaging="true" ID="gvSpeStatistics" AutoGenerateColumns="false"
        ShowExport="true" HideFieldOnExport="全部" runat="server" BindGridViewMethod="BindDataGrid"
        UseDefaultDataSource="true" ShowPageSizeChange="true" OnRowDataBound="gvSpeStatistics_RowDataBound">
        <Columns>
