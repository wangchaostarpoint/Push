<%@ Page Title="" Language="C#" MasterPageFile="~/Custom/UI/Master/CustomListNew.Master"
    AutoEventWireup="true" CodeBehind="PlanByDeptRolls.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Plan.PlanByDeptRolls" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block"><span class="filter-block-lb">年份</span> <span>
        ...
        <span>
            <asp:TextBox ID="tbProjectInfo" search="1" runat="server" CssClass="kpms-textboxsearch"
...
<asp:Content ID="Content6" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="True"
        ...
        <Columns>
            ...
            <zhongsoft:LightTemplateField HeaderText="预警提醒">
                <ItemTemplate>
                    <asp:LinkButton ID="lkbAlertInfo" runat="server" OnClientClick='<%# String.Format("return openRollList(\"{0}\",\"1\")", Eval("BelongDeptID")) %>'
    ...
    <script type="text/javascript">
        function openRollList(deptID, showWaringRow) {
            var roleName = "<%= WorkbenchRoleName%>";
            if (roleName == 'Szr') {
                roleName = "Bmfzr";
            }
            var url = buildQueryUrl("/EPMS/List/WBS/C_RollList.aspx", { DeptID: deptID, secid: '9dd62921-edc5-4767-b46a-817756ea5ca7', RoleName: roleName, IsShowAllButn: 'false', ShowWaringRow: showWaringRow });
