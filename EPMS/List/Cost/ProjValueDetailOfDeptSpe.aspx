<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="ProjValueDetailOfDeptSpe.aspx.cs"
    Inherits="Zhongsoft.Portal.EPMS.List.Cost.ProjValueDetailOfDeptSpe" MasterPageFile="~/UI/Master/ObjectList.Master" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="true"
        PageSize="30" AutoGenerateColumns="false" ShowExport="true" ShowPageSizeChange="true"
