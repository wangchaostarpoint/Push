<%@ Page Title="阶段项目月度完成产值统计" Language="C#" MasterPageFile="~/UI/Master/ObjectList.Master"
    AutoEventWireup="true" CodeBehind="ProjectPerMonthValuesList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Cost.ProjectPerMonthValuesList" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    ...
    <zhongsoft:LightPowerGridView Width="98%" runat="server" ID="gvList" AllowPaging="true"
        ...
        ShowPageSizeChange="true" ShowEmptyDataHeader="false" AllowFrozing="true" FrozenColNum="7"
