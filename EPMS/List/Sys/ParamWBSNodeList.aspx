<%@ Page Language="C#" AutoEventWireup="true" Title="WBS任务节点参数设置" MasterPageFile="~/UI/Master/ObjectList.Master"
    CodeBehind="ParamWBSNodeList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Sys.ParamWBSNodeList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="treeView" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block"><span class="filter-block-lb">任务节点</span> <span>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="True"
        ...
        DataKeyNames="ParamWBSNodeID" UseDefaultDataSource="true" BindGridViewMethod="BindGrid"
        ...
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="WBSNode" HeaderText="任务作业节点">
            ...
            <zhongsoft:LightTemplateField HeaderText="是否启用">
                <ItemTemplate>
                    <asp:RadioButtonList runat="server" ID="rbl" RepeatDirection="Horizontal" key='<%#Eval("ParamWBSNodeID") %>'
                        OnSelectedIndexChanged="rbl_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem Value="1">启用</asp:ListItem>
                        <asp:ListItem Value="0">不启用</asp:ListItem>
                    </asp:RadioButtonList>
                    <input type="hidden" runat="server" id="hiKeyId" value='<%#Eval("ParamWBSNodeID") %>' />
                </ItemTemplate>
            </zhongsoft:LightTemplateField>
        </Columns>
