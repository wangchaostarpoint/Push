<%@ Page Language="C#" AutoEventWireup="true" Title="质量相关参数设置" MasterPageFile="~/UI/Master/ObjectList.Master"
    CodeBehind="ParamQualityList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Sys.ParamQualityList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="True"
        ...
        DataKeyNames="ParamQualityID" UseDefaultDataSource="true" BindGridViewMethod="BindGrid"
        ...
        <Columns>
            ...
            <zhongsoft:LightTemplateField HeaderText="是否启用">
                <ItemTemplate>
                    <asp:RadioButtonList runat="server" ID="rbl" RepeatDirection="Horizontal" key='<%#Eval("ParamQualityID") %>'
