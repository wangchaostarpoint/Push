<%@ Page Language="C#" AutoEventWireup="true" Title="资料性质参数设置" MasterPageFile="~/UI/Master/ObjectList.Master"
    CodeBehind="ParamFileNatureList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Sys.ParamFileNatureList" %>

<asp:Content ID="Content1" ContentPlaceHolderID="treeView" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block"><span class="filter-block-lb">资料性质</span> <span>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView Width="100%" runat="server" ID="gvList" AllowPaging="True"
        ...
        DataKeyNames="ParamFileNatureID" UseDefaultDataSource="true" BindGridViewMethod="BindGrid"
        ...
        <Columns>
            ...
            <zhongsoft:LightTemplateField HeaderText="是否启用">
                <ItemTemplate>
                    <asp:RadioButtonList runat="server" ID="rbl" RepeatDirection="Horizontal" key='<%#Eval("ParamFileNatureID") %>'
                        OnSelectedIndexChanged="rbl_SelectedIndexChanged" AutoPostBack="true">
                        <asp:ListItem Value="1">启用</asp:ListItem>
                        <asp:ListItem Value="0">不启用</asp:ListItem>
                    </asp:RadioButtonList>
                    <input type="hidden" runat="server" id="hiKeyId" value='<%#Eval("ParamFileNatureID") %>' />
                </ItemTemplate>
            </zhongsoft:LightTemplateField>
        </Columns>
