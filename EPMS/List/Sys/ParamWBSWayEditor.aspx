<%@ Page Language="C#" AutoEventWireup="true" Title="任务作业（系统）方式参数编辑" MasterPageFile="~/UI/Master/ObjectEditor.Master"
    CodeBehind="ParamWBSWayEditor.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Sys.ParamWBSWayEditor" %>

<asp:Content ID="Content2" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    <table class="tz-table" style="width: 100%">
        <tr>
            <td class="td-l" style="white-space: nowrap;">
                作业（系统）方式<span class="req-star">*</span>
            </td>
            <td class="td-m" colspan="3">
                <zhongsoft:LightTextBox runat="server" ID="tbType" TableName="EPMS_PARAMBUSINESSTYPE"
                    Field="WBSWay" activestatus="(23.*)" req="1"></zhongsoft:LightTextBox>
            </td>
        </tr>
        <tr>
            <td class="td-l">
                归属<span class="req-star">*</span>
            </td>
            <td class="td-m" colspan="3">
                <zhongsoft:LightDropDownList runat="server" ID="ddlClass" TableName="EPMS_PARAMBUSINESSTYPE"
                    Field="WayClass" activestatus="(23.*)" req="1">
    ...
    <input id="hikeyID" type="hidden" tablename="EPMS_PARAMBUSINESSTYPE" field="ParamWBSWayId"
        runat="server" />
    <script>
