<%@ Page Language="C#" AutoEventWireup="true" Title="WBS任务类别参数设置" MasterPageFile="~/UI/Master/ObjectList.Master"
    CodeBehind="ParamWBSTypeList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Sys.ParamWBSTypeList" %>
...
<asp:Content ID="Content4" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:TreeGridView Width="100%" runat="server" ID="tgvList" AllowPaging="true"
        ...
        DataKeyNames="ParamWBSTypeID" UseDefaultDataSource="true" BindGridViewMethod="BindGrid"
        OnRowDataBound="gvList_RowDataBound" OnRowCommand="gvList_RowCommand" ParentIdColumn="PARENTID"
        SelfIdColumn="ParamWBSTypeID">
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="WBSMode" HeaderText="任务管理方式">
            ...
            <zhongsoft:LightTemplateField HeaderText="关联的作业节点">
                <ItemTemplate>
                    <%--<asp:CheckBox runat="server" ID="cbAllNode" Text="选择全部作业节点" OnCheckedChanged="cbAllNode_CheckedChanged"
                        AutoPostBack="true" />
                    <asp:CheckBoxList runat="server" ID="cblNode" RepeatDirection="Horizontal" RepeatColumns="3"
                        OnSelectedIndexChanged="cblNode_SelectedIndexChanged" AutoPostBack="true">
                    </asp:CheckBoxList>--%>
                    <asp:Label runat="server" ID="lbWBSNodes"></asp:Label>
                </ItemTemplate>
            </zhongsoft:LightTemplateField>
