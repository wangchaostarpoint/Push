<%@ Page Language="C#" Title="部门/项目中高风险管理表" AutoEventWireup="true" CodeBehind="HighRiskReportList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.Risk.HighRiskReportList" MasterPageFile="~/UI/Master/ObjectList.Master" %>
