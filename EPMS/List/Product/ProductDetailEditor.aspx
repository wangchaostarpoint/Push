...
<asp:Content ID="Content2" ContentPlaceHolderID="BusinessObjectHolder" runat="server">
    ...
    <div id="templateTabs">
        <ul>
            <li id="liMap"><a href='javascript:void(0)' onclick="showDetail('mapInfo')">图纸</a></li>
            <li id="liText"><a href='javascript:void(0)' onclick="showDetail('textInfo')">其他</a></li>
            <li id="liSign"><a href='javascript:void(0)' onclick="showDetail('signInfo')">会签成品</a></li>
            <li id="liOpinion"><a href='javascript:void(0)' onclick="showDetail('oppionInfo')">校审意见</a></li>
        </ul>
        <table width="100%">
            <tr>
                                ...
                                <td id="tdProduct">
                                    <table width="100%">
                                        <tr>
                                            ...
                                            <td class="td-l" style="display:none">成品类别
                                            </td>
                                            ...
                                            <td class="td-r" style="width:150px;">
                                                ...
                                                <div style="overflow-y: auto; max-height: 440px;">
                                                    <zhongsoft:LightPowerGridView runat="server" Width="100%" ID="gvProductList" AllowPaging="false"
                                                        ...
                                                        <Columns>
                                                            ...
                                                            <zhongsoft:LightTemplateField HeaderText="成品类别" Visible="false">
                                                                <ItemTemplate>
