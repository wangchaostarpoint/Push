<%@ Page Title="工代服务策划台帐" Language="C#" MasterPageFile="~/UI/Master/ObjectList.Master" AutoEventWireup="true" CodeBehind="GDServicePlanList.aspx.cs" Inherits="Zhongsoft.Portal.EPMS.List.GDManage.GDServicePlanList" %>
...
<asp:Content ID="Content5" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView runat="server" ID="gvList" AutoGenerateColumns="false"
        ...
        <Columns>
                ...
                <ItemTemplate>
                    <asp:LinkButton ID="lbtnViewForm" runat="server" EnableTheming="false" OnClientClick="return false">
                        <img alt="img" src="../../../Themes/Images/btn_dg_view.gif"  title="查看流程信息"
                             onclick="viewWF('<%# Eval("GDServicePlanID") %>','');"/>
                    </asp:LinkButton>
                </ItemTemplate>
            </zhongsoft:LightTemplateField>
            ...
            <zhongsoft:LightBoundField HeaderText="简要内容" DataField="Content" Width="650px" ShowToolTip="True" />
        </Columns>
    ...
    <script type="text/javascript">
        ...
        function startWF() {
            ...
            var url = buildQueryUrl("/Sys/Workflow/FormDetail.aspx", {
                actionType: 2, packageName: 'EPMSDServicePlan.xpdl', xpdlId: 'EPMSDServicePlan_wp1', formId: 443, ver:
