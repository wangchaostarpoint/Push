<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectRollModify.aspx.cs"
    Inherits="Zhongsoft.Portal.EPMS.List.ProjectData.ProjectRollModify" MasterPageFile="~/UI/Master/ObjectList.Master" Title="专业任务进度计划" %>

<%@ Import Namespace="DAL.EPMS" %>
<asp:Content ID="Content1" ContentPlaceHolderID="toolBar" runat="server">
    <span class="filter-block">
        <span class="filter-block-lb">任务编号/名称</span>
        <span>
    ...
    <span class="filter-block">
        <span class="filter-block-lb">任务负责人</span>
        <span>
    ...
    <br />
    <span class="filter-block" flag="IsAdd">
        <span>
    ...
    <span class="filter-block" flag="IsModify">
        <span>
            <asp:LinkButton runat="server" ID="lbtnEditSpeMemo" ToolTip="专业在这里勾选任务提出修改计划时间及原因" EnableTheming="false" OnClick="lbtnEditSpeMemo_Click"
                flag="import" OnClientClick="return showMemoInfo('speInfo')" Style="color: blue"><span><h4>添加专业备注</h4></span></asp:LinkButton>
        </span>
    </span>
    <span class="filter-block" flag="IsModifyForm">
        <span>
            <asp:LinkButton ID="lbtnStartPlanChangeForm" runat="server" OnClientClick="return startPlanChangeForm();" EnableTheming="false"
                Style="color: blue">
                <span><h4>进度变更申请</h4></span>
            </asp:LinkButton>
        </span>
    </span>
    ...
    <span class="filter-block" flag="fileEditShow1" style="display: none">
        <span>
            <asp:LinkButton ID="btnAddWbs" runat="server" EnableTheming="false"
                Style="color: blue">
                <span><h4>选择任务模板</h4></span>
            </asp:LinkButton>
        </span>
    </span>

    <span class="filter-block" flag="IsOnlyView">
        <span>
            <asp:LinkButton runat="server" ID="lbtnInport" EnableTheming="false"
                flag="import" OnClientClick="return inExport()" Style="color: blue"><span><h4>导入《专业任务及计划》</h4></span></asp:LinkButton>
        </span>
    </span>
    ...
    <span class="filter-block" flag="planGantt">
        <span>
            <a style="color: blue" onclick="viewPlanGantt()">
                <h4>项目计划甘特图</h4>
            </a>
        </span>
    </span>
...
<asp:Content ID="Content3" ContentPlaceHolderID="listGrid" runat="server">
    <zhongsoft:LightPowerGridView ID="gvList" runat="server" DataKeyNames="WBSID,WBSState,WBSFlag"
        ...
        <Columns>
            ...
            <zhongsoft:LightTemplateField HeaderText="任务名称" ItemStyle-Width="50px">
                <ItemTemplate>
                    <a class="aStyle"
            ...
            <zhongsoft:LightTemplateField HeaderText="提交流程" ItemStyle-Width="80px">
                <ItemTemplate>
                    ...
                    <a id="clickmenu" runat="server" flag="clickmenu" fileid='<%#Eval("WBSID") %>' style="color: blue">提交流程<img src="<%=WebAppPath %>/Themes/Images/ddl.gif" /></a>
                </ItemTemplate>
            </zhongsoft:LightTemplateField>
            ...
            <zhongsoft:LightBoundField DataField="ProductLevel" HeaderText="图纸级别" SortExpression="ProductLevel" Visible="false">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="PlanTerm" HeaderText="计划工时" SortExpression="PlanTerm" Visible="false"
                ItemStyle-HorizontalAlign="Right" DataFormatString="{0:F0}">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="IsYlgd" HeaderText="是否压力管道" SortExpression="IsYlgd" Visible="false">
            </zhongsoft:LightBoundField>
            ...
            <zhongsoft:LightBoundField DataField="ProjectMemo" HeaderText="项目备注" Visible="false">
            </zhongsoft:LightBoundField>
    ...
    <zhongsoft:LightPowerGridView ID="gvExport" runat="server" AutoGenerateColumns="False" AllowPaging="True" AllowSorting="true" ShowExport="true" OnExport="gvExport_Export" Style="display: none">
        <Columns>
            ...
            <zhongsoft:LightBoundField DataField="ProductLevel" HeaderText="图纸级别" Visible="false">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="BelongModule" HeaderText="系统、厂房">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="IsYlgd" HeaderText="是否压力管道" Visible="false">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="JKWBSCode" HeaderText="关联接口" Visible="false">
            </zhongsoft:LightBoundField>
            ...
            <zhongsoft:LightBoundField DataField="WBSFlag" HeaderText="标识" Visible="false">
            </zhongsoft:LightBoundField>
            ...
            <zhongsoft:LightBoundField DataField="ApplyChangeTime" HeaderText="申请计划调整时间" DataFormatString="{0:yyyy-MM-dd}" Visible="false">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="ApplyChangeReason" HeaderText="调整原因" Visible="false">
            </zhongsoft:LightBoundField>
            <zhongsoft:LightBoundField DataField="ImpactOnSite" HeaderText="对现场是否有影响" Visible="false">
            </zhongsoft:LightBoundField>
    ...
    <script type="text/javascript">
        ...
        function inExport() {
            var json = { OrganizationID: '<%=OrganizationID %>', WbsType: '<%=WBSType.任务.ToString()%>' }
        ...
        function openDownLoad() {
            ...
            if (temCount == "0" || temCount == "") {
                ...
                var url = buildQueryUrl('/EPMS/Download/卷册目录清单（模板）.xlsx', null);
                window.open(url);
        ...
        function viewPlanGantt() {
            ...
            //showDivDialog(url, null, w, h, null);
            window.open(url);
        }
