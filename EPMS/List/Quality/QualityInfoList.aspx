<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="QualityInfoList.aspx.cs"
    Inherits="Zhongsoft.Portal.EPMS.List.Quality.QualityInfoList" MasterPageFile="~/Custom/UI/Master/CustomListNew.Master" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="toolBar" runat="server">
    ...
    </span></span>--%><span class="filter-block"><span class="filter-block-lb">专业</span>
        <span>
...
<asp:Content ID="Content1" ContentPlaceHolderID="advSearch" runat="server">
    ...
    </span></span><span class="filter-block"><span class="filter-block-lb">主题词</span> <span>
