<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="WBSVerifyOperator2.ascx.cs"
    Inherits="Zhongsoft.Portal.EPMS.UI.Product.WBSVerifyOperator2" %>
...
<input type="hidden" runat="server" id="hiNGDeptID" value="8860E25D-9C92-402F-8AA7-5290B52B98D5" />
